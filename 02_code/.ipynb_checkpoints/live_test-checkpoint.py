...
#output = cv2.VideoWriter("../01_materials/exported_materials/live.mp4", vid_cod, 20.0, (640,480))

if args["save"]:
    out = cv2.VideoWriter(path + "liveoutput.mp4", cv2.VideoWriter_fourcc('m','p','4','v'), 10, (450,253))
